 ...
 *
 * <p>This service initializes the following session variables: - subscribeId - userRoles - isAdmin
 * - hiddenCalendars - startDate - timezone - days
 *
 * @author Jen Bourey
 * @version $Revision$
 */
public class SessionSetupInitializationService implements IInitializationService {
  ...
  public void initialize(PortletRequest request) {
    ...
    session.setAttribute(
        "isAdmin", request.isUserInRole("calendarAdmin"), PortletSession.APPLICATION_SCOPE);

    /**
     * Update the user's calendar subscriptions to include any calendars that have been associated
