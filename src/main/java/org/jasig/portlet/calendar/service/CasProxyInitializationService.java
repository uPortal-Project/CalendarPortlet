 ...
 * session with the portlet. It's important that this initialization is performed when the portlet
 * session is first created, rather than waiting until the first CAS-protected calendar is
 * requested, since the proxy ticket might otherwise expire before it's validated.
 *
 * @author Jen Bourey
 */
