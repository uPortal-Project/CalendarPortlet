...
/**
 * PredefinedCalendarConfiguration represents a user configuration of a built-in calendar
 * definition. There may be many configurations for each predefined calendar definition. This class
 * defines an extra place to put user-specific configuration information and preferences.
 *
 * @author Jen Bourey
 */
  ...
  public void setCalendarDefinition(CalendarDefinition definition) {
    if (!(definition instanceof PredefinedCalendarDefinition)) {
      throw new IllegalArgumentException(
          "Predefined calendar configurations may only point to a predefined calendar definition");
    }
