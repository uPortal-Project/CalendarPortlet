...
/**
 * {@link IUrlCreator} implementation specific for integrating with CalendarKey
 * (http://mywebspace.wisc.edu/npblair/calendarkey).
 *
 * <p>CalendarKey instances can expose a REST style web service for retrieving individual user
 * calendars. These REST urls are built in the following way:
 *
 * <ol>
 *   <li>baseUrl, retrieved from the {@link CalendarConfiguration}, in a property named "baseUrl"
 *   <li>the current authenticated user's name (from PortletRequest.getRemoteUser() or
 *       HttpServletRequest.getRemoteUser())
 *   <li>The startDate and endDate, retrieved from the period
 * </ol>
 *
 * The following example url retrieves the calendar for user "netid" between Oct 9 2008 and Oct 10
 * 2008:
 *
 * <pre>
