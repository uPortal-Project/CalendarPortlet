...
public class StringTemplateUrlCreatorImpl implements IUrlCreator {
  ...
  public String constructUrl(
      CalendarConfiguration configuration, Interval interval, PortletRequest request) {
   ...
   * @return
   */
  public String constructUrlInternal(
      CalendarConfiguration configuration, Interval interval, String username) {
    ...
    try {
      ...
      if (url.contains(START_DATE_TOKEN) || url.contains(END_DATE_TOKEN)) {
        ...
        String urlDateFormat =
            (String) configuration.getCalendarDefinition().getParameters().get("urlDateFormat");
