...
/**
 * UserDefinedCalendarConfiguration represents a user-created calendar configuration. There should
 * only be one calendar configuration for each user-defined calendar definition. Since this is a
 * one-to-one relationship, the UserDefinedCalendarConfiguration doesn't need to define an extra
 * bucket for user-specific configuration information.
 *
 * @author Jen Bourey
 */
