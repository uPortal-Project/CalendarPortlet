...
/**
 * PortletPreferencesCalendarSetDao provides a portlet preference-based implementation of the
 * ICalendarSetDao interface. This implementation is currently very limited and does not support the
 * addition of user editing or configuration or interact with any of the roles features.
 *
...
public final class PortletPreferencesCalendarSetDao implements ICalendarSetDao {
  ...
  private static final String CALENDAR_SET_KEY =
      "PortletPreferencesCalendarSetDao.CALENDAR_SET_KEY";
  ...
  public CalendarSet<CalendarConfiguration> getCalendarSet(PortletRequest request) {
    ...
    CalendarSet<CalendarConfiguration> rslt =
        (CalendarSet<CalendarConfiguration>) session.getAttribute(CALENDAR_SET_KEY);
    if (rslt == null) {
