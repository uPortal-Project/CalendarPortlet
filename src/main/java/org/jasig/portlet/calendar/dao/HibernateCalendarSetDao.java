...
public class HibernateCalendarSetDao implements ICalendarSetDao {
  ...
  public CalendarSet<?> getCalendarSet(PortletRequest request) {
    ...
    final Set<UserDefinedCalendarConfiguration> calendars =
        new HashSet<UserDefinedCalendarConfiguration>();
    ...
    if (username != null) {
      ...
      final List<UserDefinedCalendarConfiguration> cals =
          calendarStore.getCalendarConfigurations(username);
