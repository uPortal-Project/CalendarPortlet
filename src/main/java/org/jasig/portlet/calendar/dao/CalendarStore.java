...
public interface CalendarStore {
   ...
   *
   * @param subscribeId unique ID for this portlet subscription
   * @param visibleOnly <code>true</code> to retrieve only non-hidden calendar configurations,
  ...
  /**
   * Retrieve a <code>PredefinedCalendarConfiguration</code> for the specified subscribeId and name.
   *
   * @param subscribeId unique ID for this portlet subscription
