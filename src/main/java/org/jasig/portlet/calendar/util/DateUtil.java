...
public class DateUtil {
  ...
  public static Interval getInterval(String startDate, int days, PortletRequest request)
    ...
    final DateTimeFormatter df =
        new DateTimeFormatterBuilder().appendPattern("MMddyyyy").toFormatter().withZone(tz);
