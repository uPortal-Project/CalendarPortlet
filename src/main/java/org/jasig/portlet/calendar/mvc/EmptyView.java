...
public class EmptyView extends AbstractView {
  ...
  /**
   * Sets the {@code JsonEncoding} for this converter. By default, {@linkplain JsonEncoding#UTF8
   * UTF-8} is used.
   */
  ...
  /**
   * Indicates whether the JSON output by this view should be prefixed with "{@code {} &&}". Default
   * is false.
   *
  ...
  /**
   * Sets the attributes in the model that should be rendered by this view. When set, all other
