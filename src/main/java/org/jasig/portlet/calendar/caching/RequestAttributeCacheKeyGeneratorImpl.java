...
/**
 * RequestAttributeCacheKeyGeneratorImpl is an implementation of ICacheKeyGenerator that appends the
 * current session username to the generated key. This implementation requires the username to be
 * added to the session on the user's first login and must therefore by used with one of the
