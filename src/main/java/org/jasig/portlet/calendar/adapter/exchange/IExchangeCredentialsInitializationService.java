...
public interface IExchangeCredentialsInitializationService extends IInitializationService {
  ...
  /**
   * Calculate the NT account ID string in the form of username@NTDomain of the user whose account
   * is being accessed if Exchange Impersonation is being used, else null if not using Exchange
   * Impersonation.
   *
   * @param request Portlet Request
